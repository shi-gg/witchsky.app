...
export const DEFAULT_PALETTE: Palette = {
  ...
  primary_25: `hsl(0, 30%, 97%)`,
  primary_50: `hsl(0, 30%, 95%)`,
  primary_100: `hsl(0, 30%, 90%)`,
  primary_200: `hsl(0, 32%, 80%)`,
  primary_300: `hsl(0, 34%, 70%)`,
  primary_400: `hsl(0, 35%, 58%)`,
  primary_500: `hsl(0, 35%, 45%)`,
  primary_600: `hsl(0, 38%, 38%)`,
  primary_700: `hsl(0, 40%, 32%)`,
  primary_800: `hsl(0, 42%, 25%)`,
  primary_900: `hsl(0, 45%, 18%)`,
  primary_950: `hsl(0, 48%, 10%)`,
  primary_975: `hsl(0, 50%, 7%)`,
...
export const DEFAULT_SUBDUED_PALETTE: Palette = {
  ...
  contrast_950: '#514D4D',
  contrast_975: '#444040',
  contrast_1000: '#383434',

  primary_25: `hsl(0, 30%, 97%)`,
  primary_50: `hsl(0, 30%, 96%)`,
  primary_100: `hsl(0, 30%, 92%)`,
  primary_200: `hsl(0, 32%, 81%)`,
  primary_300: `hsl(0, 33%, 72%)`,
  primary_400: `hsl(0, 33%, 60%)`,
  primary_500: `hsl(0, 33.3%, 52.9%)`,
  primary_600: `hsl(0, 35%, 43%)`,
  primary_700: `hsl(0, 40%, 36%)`,
  primary_800: `hsl(0, 42%, 30%)`,
  primary_900: `hsl(0, 45%, 22%)`,
  primary_950: `hsl(0, 48%, 10%)`,
  primary_975: `hsl(0, 50%, 8%)`,
